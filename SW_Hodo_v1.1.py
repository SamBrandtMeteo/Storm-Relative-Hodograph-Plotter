...
"""
###############################################################################
# Sam Brandt's Storm-Relative Hodograph Plotter v1.1
###############################################################################
...
if datasource=='RAP/RUC':
    ...
    north_lat = center_lat + .25
    south_lat = center_lat - .25
    west_lon = center_lon - .25
    east_lon = center_lon + .25
    ...
    for attempt in range(5):
        try:
            try:
                ...
                query = data.query()
                # Subsets by data
                query.variables('Geopotential_height_isobaric','u-component_of_wind_isobaric', 'v-component_of_wind_isobaric','Geopotential_height_surface','u-component_of_wind_height_above_ground','v-component_of_wind_height_above_ground').add_lonlat()
                # Subsets by area
